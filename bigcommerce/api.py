...
class Brand(Resource):
    ...
    def create(self):
        """Creates a new brand"""
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/brands', body)
...
class Customer(Resource):
    ...
    def create(self):
        ...
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/customers', body)

    def update(self):
        """Updates local changes to the customer"""
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/customers/' + str(self.id), body)
...
class Order(Resource):
    ...
    def create(self):
        """Creates a new order"""
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/orders', body)
...
class OptionSet(Resource):
    ...
    def create(self):
        ...
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/optionsets', body)

    def update(self):
        """Updates local changes to the option set"""
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/optionsets/' + str(self.id), body)
...
class Category(Resource):
    ...
    def create(self):
        ...
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/categories', body)

    def update(self):
        """Updates local changes to the category"""
        body = json.dumps(self.get_fields())
        self.client.request_json('PUT', '/categories/' + str(self.id), body)
...
class Image(Resource):
    ...
    def create(self, prod_id, fields=None):
        """Creates a new image"""
        body = json.dumps(fields)
        self.client.request_json('POST', '/products/%s/images' % (prod_id, body))

    def update(self, prod_id, img_id):
        """Updates image for product"""
        body = json.dumps(self.get_fields())
        image = self.client.request_json('PUT', '/products/%s/images%s' % (prod_id, img_id), body)
        print image

    def delete(self, prod_id, img_id, body):
        """Deletes image"""
